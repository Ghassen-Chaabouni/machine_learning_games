...
function draw() {
  for (var i = 0; i < 2; i++) {
    if (done) {
      ...
      if (
        600 - bodyA.position.y > 70 &&
        600 - bodyB.position.y > 70 &&
        600 - bodyC.position.y > 70
      ) {
        reward = Math.max(
        ...
        (600 - bodyA.position.y > 70 && 600 - bodyB.position.y > 70) ||
        (600 - bodyB.position.y > 70 && 600 - bodyC.position.y > 70)
      ) {
        reward =
          Math.max(
            600 - bodyA.position.y,
